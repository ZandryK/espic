    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content card">
            ...
            <div class="entete card-header bg-primary d-flex flex-row align-content-center align-items-center">
                <h4 class="text-center d-flex justify-content-center my-auto" style="color:white; font-size:16px;">Definir comme utilisateur</h4>
                <button type="button" class="close ml-auto" data-dismiss="modal">&times;</button>
            </div>

            <!-- Modal body -->
            <form method="POST" action="{{route('save.cours')}}">
                <div class="card-body">
                        @csrf
                        <div class="form-group">
                            <label for="cours">Mots de passe:</label>
                            <input type="password" class="form-control validate" required id="cours" name="designation">
                        </div> 
                </div>
