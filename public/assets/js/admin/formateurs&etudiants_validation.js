...
document.getElementById("next").addEventListener("click",(e)=>{
    ...
    switch ("") {
        ...
        case prenom.value:
            ...
            document.getElementById("alert-prenom").innerHTML = '<i class="fa fa-warning"></i>&nbsp; Prenom ne peut pas être vide';
            break;
        case email.value:
        ...
        case phone.value:
            ...
            document.getElementById("alert-phone").innerHTML = '<i class="fa fa-warning"></i>&nbsp; Contact ne peut pas être vide';
            break;
        default:
            $("#Ajout").carousel("next");
            break;
    ...
    item.addEventListener("input",()=>{
        ...
        switch (id) {
            ...
            case "nom":
                ...
                break;
            case "prenom":
                const prenom = regex("texte");
                if (!prenom.test(item.value)) {
                    item.classList.add("is-invalid")
                    document.getElementById("alert-prenom").innerHTML = '<i class="fa fa-warning"></i>&nbsp; Prenom trop court';
                }else{
                    item.classList.remove("is-invalid");
                }
                break;
            case "email":
                ...
                break;
            case "phone":
                const phone = regex('tel');
                if (!phone.test(item.value)) {
                    item.classList.add("is-invalid")
                    document.getElementById("alert-phone").innerHTML = '<i class="fa fa-warning"></i>&nbsp; telephone incorect';
                }else{
                    item.classList.remove("is-invalid");
                }
                break;
