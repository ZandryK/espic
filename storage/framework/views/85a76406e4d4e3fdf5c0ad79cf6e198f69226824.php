    ...
    <div class="profil">
        <div class="contenu card">
            ...
            <div class="card-body table-responsive">
                ...
                <tbody>
                    <?php $__currentLoopData = $usrgrp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <th scope="row"><?php echo e($index+1); ?></th>
                        <td><?php echo e($user->group_name); ?></td>
                        <td><?php echo e($user->user->count()); ?></td>
                        <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layout.appAdmin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zandry_kely/Documents/Dev/laravel/projet/resources/views/Admin/usergroup.blade.php ENDPATH**/ ?>