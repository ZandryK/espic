...
<div class="content-menu">
    <div class="center">
        ...
        <div class="card">
            <a href="<?php echo e(route('view.cours')); ?>">
                <figure>
                    <span><i class="fa fa-book"></i></span>
                    <figcaption>
                        <h3>Cours</h3>
                        <p>Gerer vos cours, ajouter, supprimer, modifier</p>
                        <a href="<?php echo e(route('view.cours')); ?>">voir plus</a>
                    </figcaption>
                </figure>
            </a>
        </div>
        <div href="" class="card">
            <a href="<?php echo e(route('view.personnels',["key"=>"formateur"])); ?>">
                <figure>
                    <span><i class="fa fa-users"></i></span>
                    <figcaption>
                        <h3>Formateurs</h3>
                        <p>Gerer vos formateurs, ajouter, supprimer, modifier</p>
                        <a href="<?php echo e(route('view.personnels',["key"=>"formateur"])); ?>">voir plus</a>
                    </figcaption>
                </figure>
            </a>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.appAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zandry_kely/Documents/projet/resources/views/Admin/menu.blade.php ENDPATH**/ ?>