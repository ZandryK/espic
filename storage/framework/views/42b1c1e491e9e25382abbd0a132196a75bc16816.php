                ...
                <div class="input">
                    <?php if($key == "vagues"): ?>
                        ...
                        <div class="custom-control custom-checkbox mb-3">
                            ...
                            <label class="custom-control-label" for="<?php echo e($data->id); ?>"><?php echo e($data->filieres_designation); ?>|<?php echo e($data->niveau_etudes_designation); ?></label>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layout.appAdmin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zandry_kely/Documents/Dev/laravel/projet/resources/views/Admin/attribution.blade.php ENDPATH**/ ?>